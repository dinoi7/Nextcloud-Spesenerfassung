...
const messages = {
  de: {
    ...
    camera: 'Kamera',
    fileInfo: 'PDF, JPG, PNG (max. 1 MB) – Bilder werden automatisch verkleinert',
    ...
    statusApproved: 'Freigegeben Präsident',
    statusRejected: 'Zurückgewiesen',
    statusPaid: 'Ausbezahlt',
    statusInPayout: 'In Auszahlung',
    statusDone: 'Erledigt',
    ...
    profile: 'Profil',
    bankWarning: 'Für Bankauszahlung müssen IBAN, PLZ und Stadt/Ort im Profil hinterlegt werden.',
    gotoProfile: 'Zum Profil',
    ibanLabel: 'IBAN',
    ibanInvalid: 'Ungültige CH-IBAN',
    ibanNotCH: 'IBAN muss mit CH beginnen',
    cityLabel: 'Stadt / Ort',
    cityRequired: 'Stadt/Ort ist erforderlich für Bank-Auszahlung.',
    ...
    exportCsv: 'CSV exportieren',
		payAll: 'Alle als Ausbezahlt markieren',
		...
		addToBookkeeping: 'Freigabe Kassier',
		toBookkeeping: 'Freigabe Kassier',
  ...
  en: {
    ...
    camera: 'Camera',
    fileInfo: 'PDF, JPG, PNG (max. 1 MB) – images are resized automatically',
    ...
    statusApproved: 'Approved President',
    statusRejected: 'Rejected',
    statusPaid: 'Paid',
    statusInPayout: 'Payout in Progress',
    statusDone: 'Done',
    ...
    profile: 'Profile',
    bankWarning: 'For bank payout, IBAN, postal code and city must be stored in your profile.',
    gotoProfile: 'Open profile',
    ibanLabel: 'IBAN',
    ibanInvalid: 'Invalid CH IBAN',
    ibanNotCH: 'IBAN must start with CH',
    cityLabel: 'City',
    cityRequired: 'City is required for bank payout.',
