...
const messages = {
  de: {
    ...
    profile: 'Profil',
    bankWarning: 'Für Bankauszahlung müssen IBAN und PLZ im Profil hinterlegt werden.',
  ...
  en: {
    ...
    profile: 'Profile',
    bankWarning: 'For bank payout, IBAN and postal code must be stored in your profile.',
