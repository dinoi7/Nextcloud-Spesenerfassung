    ...
    <div v-else class="spes-paystack-list">
      <div v-for="expense in expenses" :key="expense.id" class="spes-paystack-row">
        ...
        <div v-if="expense.payoutMethod === 'bank' && expense.iban" class="spes-paystack-payment">
          ...
          <SwissQrCode :iban="expense.iban" :name="expense.submitterName || expense.displayName" :amount="expense.amount" :plz="expense.plz" :city="expense.city" :reference="'SpesenNr. ' + expense.id + ': ' + expense.title" />
        </div>
